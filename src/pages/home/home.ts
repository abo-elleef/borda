    ...
    this.chapters = [
      ...
      },
      {
        ...
        lines: [
          ...
          {
            right: 'وأكدت زهده فيها ضرورتـــــــــــــه',
          ...
          {
            right: 'محمد ســـــــــيد الكونين والثقليـن',
          ...
          {
            right: 'كانه وهو فردٌ من جلالتـــــــــــــــه',
      ...
      },
      {
        ...
        lines: [
          ...
          {
            right: 'كأنهم هرباً أبطال أبرهـــــــــــــــةٍ',
            left: 'أو عسكرٌ بالحصى من راحتيه رمـى'
          },

          {
            right: 'نبذاً به بعد تسبيحٍ ببطنهمــــــــــــا',
      ...
      },
      {
        ...
        lines: [
          ...
          {
            right: 'ومن يبع آجلاً منه بعاجلــــــــــــهِ',
