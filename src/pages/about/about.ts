...
export class AboutPage {
  ...
  constructor(public navCtrl: NavController) {
    this.chapters = [
    {
      ...
      // lines: [
// {right: 'أمن تذَاكُرِ جِيران بِذي سلَمٍ',left: 'مزجت دمعاً جري من مقْلَة بِدمٍ'},
// {right: 'أم هبت الريح من تلْقَاءِ كَاظمة ',left: 'وأومض البرق في الظَّلْماءِ من إضمٍ'},
// {right: 'فَما لعينيك إنْ قُلْت اكْفُفَا همتا ',left: 'وما لقَلْبِك إنْ قُلْت استفق يهِمِ'},
// {right: 'أيحسِب الصب أنَّ الحُب منكَتم',left: ' ما بين منسجِمٍ منه ومضطَرِمٍ'},
// {right: 'لَولاْ الهَوى لَم ترِق دمعاً علَى طَلَلٍ ',left: 'ولاْ أرِقْت لذكْرِ الباْن والعلَمِ'},
// {right: 'فَكَيف تنكر حباً بعد ما شهِدت ',left: 'بِه علَيك عدولُ الدمعِ والسقَمِ'},
// {right: 'وأثْبت الوجد خطَّى عبرة وضنى ',left: 'مثْلَ البهارِ علَى خديك والعنمِ'},
// {right: 'نعم سرى طَيف من أهوى فَأرقَنِي ',left: 'والْحب يعترِضِ اللَّذَات بِالأَلَمِ'},
// {right: 'يا لاْئمي في الْهوى العذْرِي معذرةً ',left: 'مني إلَيك ولَو أنصفْت لَم تلُمِ'},
// {right: 'عدتك حالي لاْ سري بِمستترٍ ',left: 'عنِ الوشاْة ولاْ دائي بِمنحسِمٍ'},
// {right: 'محضتنِي النصح لَكن لَست أسمعه ',left: ' إنَّ الْمحب عنِ العذَّالِ في صممِ'},
// {right: 'إني اتـهمت نصيح الشيبِ في عذَلي ',left: 'والشيب أبعد في نصحٍ عنِ التهمِ '},
      // ]
      lines: [
      {right: 'أمن تذكــــــر جيــــــرانٍ بذى ســــــلم',
      left:'مزجت دمعا جَرَى من مقلةٍ بـــــدم'},

      {right: 'َأمْ هبَّــــت الريـــــحُ مِنْ تلقاءِ كاظمــةٍ',
      left:'وأَومض البرق في الظَّلْماءِ من إِضم'},

      {right: 'فما لعينيك إن قلت اكْفُفاهمتــــــــــ ـــــا',
      ...
      {right: 'إنى اتهمت نصيح الشيب في عـــــذلي',
    ...
    },
    {
      ...
      {right:'لو كنت أعلم أني ما أوقـــــــــــــــــ ـــره',
      left: 'كتمت سراً بدا لي منه بالكتــــــــمِ'},

      {right:'من لي برِّ جماحٍ من غوايتهــــــــــــــ ـا',
      ...
      {right:'كم حسنت لذةً للمرءِ قاتلــــــــــــــــ ــة',
    ...
    },
    {
      ...
      {right: 'وراودته الجبال الشم من ذهــــــــــبٍ',
      left: 'عن نفسه فأراها أيما شـــــــــــــــمم'},

      {right: 'وأكدت زهده فيها ضرورتـــــــــــــــ ه',
      left: 'إن الضرورة لا تعدو على العصــــم'},

      {right: 'وكيف تدعو إلى الدنيا ضرورة مـــن',
      left: 'لولاه لم تخرج الدنيا من العـــــــــدمِ'},

      {right: 'محمد ســـــــــــــــيد الكونين والثقليـ',
      left: 'ن والفريقين من عرب ومن عجـــــمِ'},

      {right: 'نبينا الآمرُ الناهي فلا أحـــــــــــــــــد ٌ',
      left: 'أبر في قولِ لا منه ولا نعـــــــــــــــــم '},
      ...
      {right: 'وواقفون لديه عند حدهـــــــــــــــــ م',
      left: 'من نقطة العلم أو من شكلة الحكـــــم'},

      {right: 'فهو الذي تـ ــــــم معناه وصورتـــــــه',
      ...
      left: 'حدٌّ فيعرب عنه ناطقٌ بفــــــــــــــــــ م'},
      ...
      left: 'حرصاً علينا فلم نرْتب ولم نهــــــــمِ'},
      ...
      left: 'قومٌ نيامٌ تسلوا عنه بالحلــــــــــــــم ِ'},

      {right: 'فمبلغ العلم فيه أنه بشــــــــــــــــــ ـرٌ',
      left: 'وأنه خير خلق الله كلهـــــــــــــــــ ـمِ'},
      ...
      {right: 'كانه وهو فردٌ من جلالتـــــــــــــــ ــه',
      left: 'في عسكر حين تلقاه وفي حشــــــم'},

      {right: 'كأنما اللؤلؤ المكنون فى صـــــــدفٍ',
    ...
    },
    {
      ...
      {right: 'أبان موالده عن طيب عنصـــــــــره',
      ...
      left: 'تسمع وبارقة الإنذار لم تُشــــــــــَم'},

      {right: 'من بعد ما أخبره الأقوام كاهِنُهُـــــــمْ',
      left: 'بأن دينهم المعوجَّ لم يقــــــــــــــــمِ '},

      {right: 'وبعد ما عاينوا في الأفق من شهـب',
      left: 'منقضةٍ وفق ما في الأرض من صنم'},

      {right: 'حتى غدا عن طريق الوحى منهــزمٌ',
      left: 'من الشياطين يقفو إثر منـــــــــهزم'},

      {right: 'كأنهم هرباً أبطال أبرهــــــــــــــــ ــةٍ',
      left: 'أو عسكرٌ بالحصى من راحتيه رمـى'},

      {right: 'نبذاً به بعد تسبيحٍ ببطنهمــــــــــــــ ا',
      left: 'نبذ المسبِّح من أحشاءِ ملتقـــــــــــم'}
      ]
    },
    {
      id: '5',
    ...
    },
    {
      ...
      {right: 'أحل أمته في حرز ملتـــــــــــــــــ ــه',
    ...
    },
    {
      ...
      { right: 'ومن يبع آجلاً منه بعاجلـــــــــــــــ هِ',
      ...
      { right: 'فإن لي ذمةً منه بتســــــــــــــــم يتي',
    ...
    },
    {
      ...
      {right: 'وبجاه من بيْتُهُ فى طيبة حــرمٌ',
    ...
    },
    {
      ...
      lines:[
      {
        ...
        right:'محمدٌ باسطُ المَعْرُوف جَامَعَة ',
        left:'ً محمدٌ صاحبُ الإحسانِ والكرمِ'
      },{
        right:'محمدٌ تاجُ رُسْلِ الله قاطِبَة ',
        left:'ً محمدٌ صادقُ الأقوالِ والكلمِ'
      },{
        right:'محمدٌ ثابِتُ المِيثاقِ حافِظُهُ',
        left:' محمدٌ طيبُ الأخلاقِ والشيمِ'
      },{
        right: 'محمدٌ خبِيَتْ بالنُّورِ طِينَتُهُ ',
        ...
        right: 'محمدٌ دِينُهُ حَقَّ النّذِيرُ بِهِ ',
        left:'محمدٌ مجملٌ حقاً على علمِ'
      },{
